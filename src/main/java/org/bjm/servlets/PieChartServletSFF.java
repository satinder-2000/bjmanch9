...
public class PieChartServletSFF extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String surveyFromForumId=request.getParameter("surveyFromForumId");
        int dia=Integer.parseInt(request.getParameter("dia"));
        ObjectId surveyFromForumIdObj=new ObjectId(surveyFromForumId);
        Bson filter=Filters.eq("surveyFromForumId", surveyFromForumIdObj);
        ...
        List<SurveyFromForumVote> surveyFromForumVoteList=new ArrayList<>();
        int agreeCt=0;
        int disagreeCt=0;
        int undecidedCt=0;
        if(!surveyFromForumVoteItr.hasNext()){
            ...
            while (surveyFromForumVoteItr.hasNext()) {
                surveyFromForumVoteList.add(surveyFromForumVoteItr.next());
            }
