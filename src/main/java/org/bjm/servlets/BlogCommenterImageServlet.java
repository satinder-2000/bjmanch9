...
public class BlogCommenterImageServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Map<ObjectId, ImageVO> blogCommenterImageMap=(Map<ObjectId, ImageVO>) session.getAttribute(BjmConstants.BLOG_COMMENTER_IMAGE_MAP);
        String blogCommenterId=request.getParameter("blogCommenterId");
        ObjectId blogCommenterIdObj=new ObjectId(blogCommenterId);
